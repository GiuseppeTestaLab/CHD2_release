---
title: "CHD2 Cortical Brain Organoids Day25 - DEGs overlap with NDD genes"
...
params: 
    ...
    DEAList_HT: '/group/testa/Project/CHD2/BulkRNAseq/results/PublicRepo/2.DEA/day25/Output/Savings/day25CbO.DEAList_HT.rds'
    DEAList_AR: '/group/testa/Project/CHD2/BulkRNAseq/results/PublicRepo/2.DEA/day25/Output/Savings/day25CbO.DEAList_AR.rds'
...
### Overlap Analysis between NDD genes and DEGs in Day25 Cortical Brain Organoids
...
ggsave(Dot, filename=paste0(params$FiguresFolder, 'KB_NDD_day25.pdf'), width=6.5, height=6.5)
```
...
```{r collapse=TRUE}
saveRDS(Res, paste0(params$SavingFolder, 'day25_NDDOverlapResults.rds'))
```

```{r SaveSession, collapse=TRUE}
SessionInfo <- sessionInfo()
Date <- date()
save.image(paste0(params$SavingFolder, 'KB_NDD_day25.RData'))
```
